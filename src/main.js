...
class GameScene extends Phaser.Scene{
  ...
  create(){
    ...
    this.player = this.physics.add.image(0, sizes.height - 100, "basket")
    .setOrigin(0, 0);
  ...
  targetHit() {
    ...
    this.targetSpeed *= 1.04;
    this.target.setVelocity(this.targetSpeed);
    this.target.setMaxVelocity(0, this.targetSpeed);
  }
  ...
  gameOver() {
    ...
    if(this.points >=10){
      ...
      gameWinLoseSpan.textContent = "It's a win !"
